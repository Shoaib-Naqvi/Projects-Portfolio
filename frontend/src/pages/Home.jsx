    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-20">
      <div className="max-w-4xl w-full text-center space-y-12">
        <motion.div
          ...
          className="inline-block p-8 bg-purple-600/5 border border-purple-500/10 rounded-[2.5rem] shadow-[0_0_50px_rgba(111,32,255,0.15)] backdrop-blur-md"
        >
        ...
        >
          <Link to="/ai-projects">
            <button className="group relative px-8 py-4 bg-purple-600 text-white rounded-2xl font-bold flex items-center space-x-3 hover:bg-purple-700 transition-all shadow-lg hover:shadow-purple-500/40">
